...
app_key = os.environ.get('APP_KEY', 'IDPRLYJaY5MgI44HdIMyAA')
app_secret = os.environ.get('APP_SECRET', 'IHECtZXnaYX4atisSVl2hKMBe18wFmvqBU79dRfVW4')
oauth_token = os.environ.get('OAUTH_TOKEN', '39434042-lGLBkphLBFj4S8c0LvxOpRy0yYKgNV34j2dtFexMO')
oauth_token_secret = os.environ.get('OAUTH_TOKEN_SECRET', 'tSqrWCig9dRe4gtYxVWFLoQNdhp6xCpEZSCiulrIZY')
access_token = os.environ.get('ACCESS_TOKEN')

screen_name = os.environ.get('SCREEN_NAME', 'frank_parker')
